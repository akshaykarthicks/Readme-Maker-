...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path fillRule="evenodd" d="M3.185 13.862c-2.26.28-4.126 2.235-4.126 4.638 0 .75.6 1.35 1.35 1.35h4.126c2.26-.28 4.125-2.235 4.125-4.638 0-.75-.6-1.35-1.35-1.35H3.185z" clipRule="evenodd" transform="translate(-2 -11)" />
    </svg>
);
